...
- [Document model](internal/document/AGENTS.md): owns the stable tree shape and shared document-tree value coercion helpers (StringValue, NumberValue, OptionalNumber, NumberSlice, MapValue). Extract imports these directly; capability-specific shaping remains here.
