...
func TestGetFile_TableDriven(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockClient.On("GetFile", context.Background(), tt.fileKey, mock.Anything).Return(tt.mockFile, tt.mockError)
...
func TestGetFile_WithFixture(t *testing.T) {
	...
	mockClient.On("GetFile", context.Background(), "fixture", mock.AnythingOfType("[]api.GetFileOption")).Return(expectedFile, nil)
