...
func (rc *RetryClient) GetFile(ctx context.Context, fileKey string, opts ...GetFileOption) (*File, error) {
	...
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetFile(ctx, fileKey, opts...)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetNode(ctx context.Context, fileKey string, nodeID string, opts ...GetNodeOption) (*Node, error) {
	var result *Node
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetNode(ctx, fileKey, nodeID, opts...)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetFileNodes(ctx context.Context, fileKey string, nodeIDs []string, opts ...GetFileNodesOption) (*FileNodesResponse, error) {
	...
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetFileNodes(ctx, fileKey, nodeIDs, opts...)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetImage(ctx context.Context, fileKey string, nodeIDs []string, options *ImageOptions) (map[string]string, error) {
	...
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetImage(ctx, fileKey, nodeIDs, options)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetComments(ctx context.Context, fileKey string) ([]*Comment, error) {
	var result []*Comment
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetComments(ctx, fileKey)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) PostComment(ctx context.Context, fileKey string, comment *CommentRequest) (*Comment, error) {
	var result *Comment
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.PostComment(ctx, fileKey, comment)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) DeleteComment(ctx context.Context, fileKey string, commentID string) error {
...
func (rc *RetryClient) GetCommentReactions(ctx context.Context, fileKey string, commentID string) ([]*Reaction, error) {
	var result []*Reaction
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetCommentReactions(ctx, fileKey, commentID)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) PostCommentReaction(ctx context.Context, fileKey string, commentID string, emoji string) error {
	return WithRetry(ctx, rc.config, func(ctx context.Context) error {
...
func (rc *RetryClient) DeleteCommentReaction(ctx context.Context, fileKey string, commentID string, emoji string) error {
	return WithRetry(ctx, rc.config, func(ctx context.Context) error {
...
func (rc *RetryClient) GetFileMetadata(ctx context.Context, fileKey string, opts ...GetFileMetadataOption) (*FileMeta, error) {
	var result *FileMeta
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetFileMetadata(ctx, fileKey, opts...)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetFileVersions(ctx context.Context, fileKey string, opts ...GetFileVersionsOption) ([]*Version, error) {
	var result []*Version
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetFileVersions(ctx, fileKey, opts...)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetTeamStyles(ctx context.Context, teamID string) ([]*Style, error) {
	var result []*Style
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetTeamStyles(ctx, teamID)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetStyle(ctx context.Context, styleKey string) (*Style, error) {
	var result *Style
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetStyle(ctx, styleKey)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetFileStyles(ctx context.Context, fileKey string) ([]*Style, error) {
	var result []*Style
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetFileStyles(ctx, fileKey)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetTeamComponents(ctx context.Context, teamID string) ([]*Component, error) {
	...
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetTeamComponents(ctx, teamID)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetComponent(ctx context.Context, componentKey string) (*Component, error) {
	var result *Component
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetComponent(ctx, componentKey)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetTeamComponentSets(ctx context.Context, teamID string) ([]*ComponentSet, error) {
	...
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetTeamComponentSets(ctx, teamID)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetComponentSet(ctx context.Context, componentSetKey string) (*ComponentSet, error) {
	var result *ComponentSet
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetComponentSet(ctx, componentSetKey)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetFileComponents(ctx context.Context, fileKey string) ([]*Component, error) {
	var result []*Component
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetFileComponents(ctx, fileKey)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetTeamProjects(ctx context.Context, teamID string) ([]*Project, error) {
	var result []*Project
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetTeamProjects(ctx, teamID)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetProjectFiles(ctx context.Context, projectID string) ([]*File, error) {
	var result []*File
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetProjectFiles(ctx, projectID)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetFileVariables(ctx context.Context, fileKey string) ([]*Variable, error) {
	var result []*Variable
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetFileVariables(ctx, fileKey)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetTeamPublishedVariables(ctx context.Context, teamID string) ([]*Variable, error) {
	var result []*Variable
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetTeamPublishedVariables(ctx, teamID)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetFileDevResources(ctx context.Context, fileKey string) ([]*DevResource, error) {
	...
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetFileDevResources(ctx, fileKey)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) GetWebhooks(ctx context.Context) ([]*Webhook, error) {
	var result []*Webhook
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.GetWebhooks(ctx)
		if err != nil {
			return err
		}
		result = res
...
func (rc *RetryClient) CreateWebhook(ctx context.Context, webhook *WebhookRequest) (*Webhook, error) {
	var result *Webhook
	err := WithRetry(ctx, rc.config, func(ctx context.Context) error {
		res, err := rc.client.CreateWebhook(ctx, webhook)
		if err != nil {
			return err
		}
		result = res
