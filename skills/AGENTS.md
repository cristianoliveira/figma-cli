...
- [Evaluation fixtures](evals/AGENTS.md): evaluates skill behavior outside the skill content.

# Placement

Put reusable agent procedures in the skill that owns the workflow. Put production behavior in Go packages and holdout answers or grader controls in `evals/`.
